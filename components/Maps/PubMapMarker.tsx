...
type PubMapMarkerProps = {
    ...
    unselectedPinColor: Color;
    unselectedDotColor: Color;
    unselectedOutlineColor: Color;
};
        ...
        <View style={[styles.container, { width }]}>
            <Svg width="100%" height="100%" viewBox="0 0 207 263" fill="none">
                <Rect
                    ...
                    width="109"
                    height="115"
                    fill={selected ? selectedDotColor : unselectedDotColor}
                />
                <Path
                    ...
                    fill={
                        selected ? selectedOutlineColor : unselectedOutlineColor
                    }
                />
                <Path
                    ...
                    fill={selected ? selectedPinColor : unselectedPinColor}
                />
            </Svg>
        </View>
    );

...
CREATE UNIQUE INDEX pub_photos_pkey ON public.pub_photos USING btree (id, pub_id);
...
alter table "public"."pub_photos" add constraint "pub_photos_pkey" PRIMARY KEY using index "pub_photos_pkey";
...
alter table "public"."pub_photos" add constraint "pub_photos_pub_id_fkey" FOREIGN KEY (pub_id) REFERENCES pubs(id) not valid;

alter table "public"."pub_photos" validate constraint "pub_photos_pub_id_fkey";

alter table "public"."pub_photos" add constraint "pub_photos_user_id_fkey" FOREIGN KEY (user_id) REFERENCES auth.users(id) not valid;

alter table "public"."pub_photos" validate constraint "pub_photos_user_id_fkey";
...
alter table "public"."reviews" add constraint "reviews_pub_id_fkey" FOREIGN KEY (pub_id) REFERENCES pubs(id) not valid;
...
LEFT JOIN reviews r ON pubs.id = r.pub_id
LEFT JOIN pub_photos pp ON pubs.id = pp.pub_id
GROUP BY pubs.id
ORDER BY
...
grant delete on table "public"."pub_photos" to "anon";

grant insert on table "public"."pub_photos" to "anon";

grant references on table "public"."pub_photos" to "anon";

grant select on table "public"."pub_photos" to "anon";

grant trigger on table "public"."pub_photos" to "anon";

grant truncate on table "public"."pub_photos" to "anon";

grant update on table "public"."pub_photos" to "anon";

grant delete on table "public"."pub_photos" to "authenticated";

grant insert on table "public"."pub_photos" to "authenticated";

grant references on table "public"."pub_photos" to "authenticated";

grant select on table "public"."pub_photos" to "authenticated";

grant trigger on table "public"."pub_photos" to "authenticated";

grant truncate on table "public"."pub_photos" to "authenticated";

grant update on table "public"."pub_photos" to "authenticated";

grant delete on table "public"."pub_photos" to "service_role";

grant insert on table "public"."pub_photos" to "service_role";

grant references on table "public"."pub_photos" to "service_role";

grant select on table "public"."pub_photos" to "service_role";

grant trigger on table "public"."pub_photos" to "service_role";

grant truncate on table "public"."pub_photos" to "service_role";

grant update on table "public"."pub_photos" to "service_role";

...
CREATE UNIQUE INDEX uq_pub_id_user_id ON public.wishlists USING btree (pub_id, user_id);
...
CREATE UNIQUE INDEX uq_username ON public.users_public USING btree (username);
...
alter table "public"."opening_hours" add constraint "check_close_hour_length" CHECK ((char_length(close_hour) = 4)) not valid;

alter table "public"."opening_hours" validate constraint "check_close_hour_length";

alter table "public"."opening_hours" add constraint "check_open_hour_length" CHECK ((char_length(open_hour) = 4)) not valid;

alter table "public"."opening_hours" validate constraint "check_open_hour_length";

alter table "public"."opening_hours" add constraint "opening_hours_pub_id_fkey" FOREIGN KEY (pub_id) REFERENCES pubs(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;
...
alter table "public"."saves" add constraint "saves_pub_id_fkey" FOREIGN KEY (pub_id) REFERENCES pubs(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;
...
alter table "public"."saves" add constraint "saves_user_id_fkey1" FOREIGN KEY (user_id) REFERENCES users_public(id) ON DELETE CASCADE not valid;

alter table "public"."saves" validate constraint "saves_user_id_fkey1";
...
alter table "public"."users_public" add constraint "uq_username" UNIQUE using index "uq_username";

alter table "public"."users_public" add constraint "users_public_id_fkey" FOREIGN KEY (id) REFERENCES auth.users(id) ON DELETE CASCADE not valid;
...
alter table "public"."wishlists" add constraint "uq_pub_id_user_id" UNIQUE using index "uq_pub_id_user_id";

alter table "public"."wishlists" add constraint "wishlists_pub_id_fkey" FOREIGN KEY (pub_id) REFERENCES pubs(id) ON DELETE CASCADE not valid;

alter table "public"."wishlists" validate constraint "wishlists_pub_id_fkey";

alter table "public"."wishlists" add constraint "wishlists_user_id_fkey" FOREIGN KEY (user_id) REFERENCES users_public(id) ON DELETE CASCADE not valid;
